...
class CcotQAEvalChain(ContextQAEvalChain):
    """LLM Chain for evaluating QA using constrainted chain of thought reasoning."""
    ...
    @property
    def evaluation_name(self) -> str:
        return "CCOT Contextual Accuracy"
